...
//Funcion de inicio del circuito
void start()
{
...
//funcion para restablecer el circuito
void reset()
{
...
//Funcion donde muestra por consola segundos, tiempo
//y estados binarios de los Leds
void mostrarConsola()
{
...
//Funcion cronometro de los numeros binarios
void cronoBinario()
{
  	start();
    reset();
